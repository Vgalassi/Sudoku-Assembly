...
.data
    ...
    INICIO db "Bem Vindo ao SUDOKU DO HEXA$"
    OPCOES db "ESCOLHA ENTRE OS JOGOS ABAIXO$"
    OP1    db "JOGO SIMPLES               (1)  JOGO DIFICIL               (2)$" 
    OP2    db "JOGAR PERSONALIZADO        (3)  CRIAR O JOGO PERSONALIZADO (4)$"
...
FIMCOLOCAVALOR:
    ...
    BANDEIRA proc               ;proc para iniciar a tela de vitória 
    reg_push                
    ...
    ;640x200        
        ...
        mov ah,09h                      ;imprimindo a mensagem de vitória
        lea dx,FraseVitoria             ;
        int 21h                         ;
    ...
    ; draw pixel -coluna -linha  -cor
        mov ah,0CH                         ;desenhando a bandeira com linha vertical 
        mov cx,160                         ;
        mov dx,103                         ;
        mov al,2                           ;
    linhavertical1:                        ;
    ...
    ; draw pixel -coluna -linha  -cor
        mov ah,0CH                         ;desenhando a bandeira com linha horizontal
        mov cx,160                         ;
        mov dx,103                         ;
        mov al,2                           ;
    linhahorizontal1:                      ;
    ...
    MOV AH,02               ;Posicionando cursor no meio superior (linha 1,coluna 32)
    MOV DH,17               ;para imprimir a mensagem do hexa
    MOV DL,37               ;
    MOV BH,0                ;
    int 10h                 ;
